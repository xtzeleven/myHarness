...
{
  "session_id": "<uuid>",
  "started_at": "2026-05-09T15:30:00",
  "current_task": "M5-T1 写 loop-architecture.md",
  "completed_steps": ["M5-T1.1 大纲", "M5-T1.2 调度决策树"],
  "pending_steps": ["M5-T1.3 中断恢复", "M5-T1.4 自反馈环"],
  "last_checkpoint": "2026-05-09T16:42:00",
  "blocked_on": null,
  "spawned_workers": [
    {"agent": "ddd-architect", "status": "completed", "output_ref": "memory/session_..."}
  ]
}
```
